...
public class Ukraine2 extends WindowProgram {
    ...
    private ArrayList<GPoint> readCities() {
        ...
        try {
            ...
            while (true) {
				/* Read the next entry, which consists of the city, the latitude, * and the longitude. */
                ...
                if (cityType != null && cityType.equals("Kirovohrad")) {
    ...
    private void plotKirovohrad(double x, double y) {
        GRect pixel = new GRect(x, y, 10, 10);
