...
class Assignment14 implements IConst {
    public static void main(String args[]) {
        ...
        if (currentCMD.action == ("-a")) {
            /*if(LOGG)*/
            System.out.println("Put to use: " + currentCMD.startFile + " Compressed to " + currentCMD.resultArhiv);
            ...
            try (BufferedInputStream buffInpS = new BufferedInputStream(new FileInputStream(currentCMD.resultArhiv));
                ...
                ProcessedFile uncompressingFile = new ProcessedFile(buffInpS, buffOutS);
