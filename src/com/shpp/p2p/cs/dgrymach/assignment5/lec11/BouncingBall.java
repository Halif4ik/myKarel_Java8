...
public class  BouncingBall extends WindowProgram {
    ...
    /**
     * Returns whether the given ball is on the screen. Возвращает, находится ли данный шар на экране.
     *
    ...
    /**
     * Returns whether the ball is above ground.  Возвращает, находится ли мяч над землей.
     *
     * @param ball The ball to check.
