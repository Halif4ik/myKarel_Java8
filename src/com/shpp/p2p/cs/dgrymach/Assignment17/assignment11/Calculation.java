...
public class Calculation implements IConst {
    private MyArrayList<String> readyPostfixFormula = new MyArrayList<>();
    protected MyHashMap<String, Double> variables = new MyHashMap<>();
     ...
     */
    void insertingVarInPostfix(MyArrayList<String> postFixFormulaInArray, MyHashMap<String, Double> variables) {
     ...
     */
     double doCalculate() {
         MyStack<Double> operandi = new MyStack<>();
        double num1;
        double num2;
