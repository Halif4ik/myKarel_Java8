...
public class CalculatorLogic {
     ...
     * @param preorThis - priority this new operator from 1 to 3
     */
    private void checkStakAndPush(String operat, int preorThis) {
        int preorPeek = 0;
