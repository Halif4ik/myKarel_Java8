...
public class DragWords extends WindowProgram {
    ...
    /**
     * Repositions the dragged object to the mouse's location when the mouse        перетаскиваемый
     * is moved.
     */
    ...
    private void addObjects() {
        try {
            ...
            BufferedReader br = new BufferedReader(new FileReader("assets/dic.txt"));
    ...
    private void addMagnet(String text) {
        ...
        double y = rgen.nextDouble(label.getAscent(), getHeight() - label.getDescent()); //Снижение
